...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2019-06-20T19:53:07Z"), f1);
		Order o2 = new Order(null, Instant.parse("2019-07-21T03:42:10Z"), f2);
		Order o3 = new Order(null, Instant.parse("2019-07-22T15:21:22Z"), f1);
